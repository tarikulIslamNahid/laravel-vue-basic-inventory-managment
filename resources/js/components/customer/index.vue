...
<router-link to="/customer/create" class="btn btn-primary ml-3">Add Customer</router-link>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for='data in filterSearch' :key="data.id" >
                        ...
                        <td>
                            <router-link :to="{name:'customeredit', params:{id:data.id}}" class="btn btn-sm   btn-primary">Edit </router-link>
                            <a href='javascript:void(0)' @click='deleteCustomer(data.id)' class="btn btn-sm   btn-danger">Delete </a>
                        </td>
                      </tr>
